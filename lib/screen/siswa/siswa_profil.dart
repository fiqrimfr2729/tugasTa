...
class _ProfilState extends State<Profil> {
  ...
  getSession() async {
    ...
    setState(() {
      ...
      nis = pref.get("nis");
      kelas = pref.get("nama_kelas");
      email = pref.get("email_siswa");
      alamat = pref.get("alamat_siswa");
      nomorhp = pref.get("no_hp");
    });
  }
  ...
  logout() async {
    ...
    Firestore.instance.collection('users').document(idUser).updateData(
          {'id_user': idUser, 'status': 'offline', 'last_seen': DateTime.now(),});
